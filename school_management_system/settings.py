...
SECRET_KEY = 'django-insecure-xnmkh7v$9epi+=%s6urk!@ydye*ro5+5!$=9p-6t(k6+irbh7w'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'school_management',  # Name of your PostgreSQL database
        'USER': 'postgres',  # PostgreSQL username
        'PASSWORD': 'yourPostgreSQLpassword ',  # PostgreSQL password  type your PostgreSQL password 
